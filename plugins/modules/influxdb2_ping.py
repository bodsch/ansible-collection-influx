...
"""Ansible module to check the health of an InfluxDB 2 instance via the HTTP API."""
...
DOCUMENTATION = r"""
---
module: influxdb2_ping
short_description: Check whether an InfluxDB 2 instance is up and healthy.
version_added: "1.3.0"
description:
  - Queries the InfluxDB 2 C(/health) endpoint via the HTTP API.
...
status:
  ...
  returned: always
version:
  description: The reported InfluxDB version, if available.
  type: str
...
def main() -> None:
    ...
    try:
        ...
        result["rc"] = 0 if status == 200 else 1
