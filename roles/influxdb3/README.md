...
influxdb3_config_dir: /etc/influxdb
influxdb3_storage_dir: /var/lib/influxdb
...
If you want to install the latest version of Influxd, you can configure the variable `influxdb3_version` with `latest`.
